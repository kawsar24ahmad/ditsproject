                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="p-4 flex justify-end">
                            <form action="{{ route('admin.service_assigns.index') }}" method="GET" class="flex gap-2">
                                <input type="text" name="search" value="{{ request('search') }}"
                                    class="border rounded-sm" placeholder="Search by invoice number">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 p-4">
                            ...
                            @empty
                            <div class="col-span-3 text-center text-gray-500 text-lg mt-8">
